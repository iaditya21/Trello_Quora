...
public class AnswerBusinessService {
    ...
    @Transactional(propagation = Propagation.REQUIRED)
    public AnswerEntity checkAnswerBelongToUser(UserAuthEntity userAuthEntity, AnswerEntity answerEntity, String operation) throws AuthorizationFailedException {
